...
public class FileAttachementRepositoryTest {
	...
	public void findByDateBeforeAndHoaxIsNull_whenAttachmentsDateOlderThanOneHorButHaveHoax_returnsNone() {
		Hoax hoax1 = testEntityManager.persist(UserUtil.createValidHoax());
		Hoax hoax2 = testEntityManager.persist(UserUtil.createValidHoax());
		Hoax hoax3 = testEntityManager.persist(UserUtil.createValidHoax());
