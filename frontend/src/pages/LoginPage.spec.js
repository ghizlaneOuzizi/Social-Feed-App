...
import { fireEvent, screen, render, waitFor, waitForElementToBeRemoved} from '@testing-library/react';
...
describe('LoginPage', () => {
    ...
    describe('Layout', ()=>{
        ...
        describe('interactions', () => {
            ...
            it('tells postLogin when the actions are provided in group and input fields have value', ()=>{
                const actions = {
            ...
            it('does not throw exception when clicking the button when actions not provided in input fields', ()=>{
            setupForSubmit();
            ...
            setupForSubmit({actions});
            fireEvent.click(button);
            const alert = await waitFor(()=> screen.findByText('Login failed'));
